...
public class AdminScopeDAOImplTest {
	...
	public void updateAdminScope() {
		...
		AdminScope adminAlredayModifiedScope = adminScopeDAO.getAdminScope("dinuka",
				APINames.COMPANY_USER);
	...
	public void isAccessGrantedFor() {
		AdminScopeDAO adminScopeDAO = AppContext.getInstance().getBean(AdminScopeDAO.class);
		assertEquals(adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY_USER,
				APIOperations.GET), true);
		assertEquals(adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY_USER,
				APIOperations.DELETE), true);
		assertEquals(adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY_USER,
				APIOperations.POST), true);
		assertEquals(adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY_USER,
				APIOperations.PUT), true);

		assertEquals(
				adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY, APIOperations.GET),
				false);
		assertEquals(
				adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY, APIOperations.DELETE),
				true);
		assertEquals(
				adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY, APIOperations.POST),
				true);
		assertEquals(
				adminScopeDAO.isAccessGrantedFor("dinuka", APINames.COMPANY, APIOperations.PUT),
				false);

		assertEquals(adminScopeDAO.isAccessGrantedFor("dinuka", APINames.ADMIN, APIOperations.GET),
				true);
		assertEquals(
				adminScopeDAO.isAccessGrantedFor("dinuka", APINames.ADMIN, APIOperations.DELETE),
				true);
		assertEquals(
				adminScopeDAO.isAccessGrantedFor("dinuka", APINames.ADMIN, APIOperations.POST),
				true);
		assertEquals(adminScopeDAO.isAccessGrantedFor("dinuka", APINames.ADMIN, APIOperations.PUT),
				true);
	...
	public void testDeleteAdminScope() {
		...
		AdminScope adminAlredayModifiedScope = adminScopeDAO
				.getAdminScope("dinuka", APINames.ADMIN);
