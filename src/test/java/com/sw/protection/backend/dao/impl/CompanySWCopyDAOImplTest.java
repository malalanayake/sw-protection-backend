...
public class CompanySWCopyDAOImplTest {
	...
	public void getAllCompanySWCopies() {
		...
		CompanySWCopy companySWCopy = companySWCopyDAO.getCompanySWCopy("client1", "Application 1",
	...
	public void updateCompanySWCopy() {
		...
		CompanySWCopy companySWCopy = companySWCopyDAO.getCompanySWCopy("client1", "Application 1",
				"M_BOARD_ID", "HD_ID", "MAC_ID");
		CompanySWCopy companySWCopyAlreadyModi = companySWCopyDAO.getCompanySWCopy("client1",
	...
	public void deleteCompanySWCopy() {
		...
		companySWCopy = companySWCopyDAO.getCompanySWCopy("client1", "Application 1", "M_BOARD_ID",
				"HD_ID", "MAC_ID");
		try {
			companySWCopyDAO.deleteCompanySWCopy(companySWCopy);
		} catch (Exception ex) {
