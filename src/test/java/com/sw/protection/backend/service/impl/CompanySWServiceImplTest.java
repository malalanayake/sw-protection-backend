...
public class CompanySWServiceImplTest {
	...
	public void saveCompanySW() {
		...
		try {
			companyUserReturn2 = companySwService.saveCompanySW(EncoderDecoderType.JSON,
					companyUserEncoded2);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void getCompanySW() {
		CompanySWService companyUserService = AppContext.getInstance().getBean(
				CompanySWService.class);
		String companyUserReturn = "";
		try {
			companyUserReturn = companyUserService.getCompanySW(EncoderDecoderType.JSON,
					"sysensor", "Application 2");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void getAllCompanySW() {
		...
		try {
			...
			companySWs = (List<CompanySW>) decoder.decodeObjectList(ObjectType.SOFTWARE,
					companySWReturn);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void updateCompanySW() {
		...
		String companySWReturn = "";
		try {
			companySWReturn = companySWService.getCompanySW(EncoderDecoderType.JSON, "sysensor",
					"Application 2");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void deleteCompanySW() {
		...
		try {
			encodedString = encoder.encodeObject(ObjectType.SOFTWARE, companySw);
			updatedfinalString = companySWService.updateCompanySW(EncoderDecoderType.JSON,
					encodedString);
		} catch (Exception e) {
