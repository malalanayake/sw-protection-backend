...
public class CompanyClientServiceImplTest {
	...
	try {
	    companyClientReturn = companyClientService.saveCompanyClient(EncoderDecoderType.JSON, companyEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyClientReturn = companyClientService
		    .saveCompanyClient(EncoderDecoderType.JSON, companyEncoded + "}{");
	} catch (Exception e) {
	...
	try {
	    companyUserReturn2 = companyClientService.saveCompanyClient(EncoderDecoderType.JSON, companyClientEncoded2);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	String companyClientReturn = "";
	try {
	    companyClientReturn = companyClientService.getCompanyClient(EncoderDecoderType.JSON, "dinuka");
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyClientReturn = companyClientService.getAllCompanyClients(EncoderDecoderType.JSON, 1, 20);
	    companyClients = (List<CompanyClient>) decoder.decodeObjectList(ObjectType.CLIENT, companyClientReturn);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyClientReturn = companyClientService.getAllCompanyClients(EncoderDecoderType.JSON, 2, 1);
	    companyClients = (List<CompanyClient>) decoder.decodeObjectList(ObjectType.CLIENT, companyClientReturn);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyClient = (CompanyClient) decoder.decodeObject(ObjectType.CLIENT, companyClientReturn);
	    companyClient2 = (CompanyClient) decoder.decodeObject(ObjectType.CLIENT, companyClientReturn);
	...
	try {
	    ...
	    finalString = companyClientService.updateCompanyClient(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
	...
	try {
	    encodedString = encoder.encodeObject(ObjectType.CLIENT, companyClient);
	    finalString = companyClientService.deleteCompanyClient(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
	    requiredDataExp = e.getClass().toString();
	}
	assertEquals(requiredDataExp, RequiredDataNotFoundException.class.toString());
	...
	try {
	    encodedString = encoder.encodeObject(ObjectType.CLIENT, companyClient);
	    updatedfinalString = companyClientService.updateCompanyClient(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
