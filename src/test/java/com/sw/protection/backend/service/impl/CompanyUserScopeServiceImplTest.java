...
public class CompanyUserScopeServiceImplTest {
	...
	JSONEncoder encoder = new JSONEncoder();
	try {
	    String companyUserScopeEncoded = companyUserScopeService.getCompanyUserScope(EncoderDecoderType.JSON,
		    "dinuka", "company-user");
	    ...
	    String companyUserScopeFinalEncoded = encoder.encodeObject(ObjectType.COMPANY_USER_SCOPE,
		    decodedCompanyUserScope);
	    companyUserScopeReturn = companyUserScopeService.updateCompanyUserScope(EncoderDecoderType.JSON,
		    companyUserScopeFinalEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    adminScopeReturn = companyUserScopeService.getCompanyUserScopes(EncoderDecoderType.JSON, "dinuka");
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	String requiredDataNotfoundExcep = "";
	try {
	    adminScopeReturn = companyUserScopeService.getCompanyUserScopes(EncoderDecoderType.JSON, "");
	} catch (Exception e) {
	...
	String companyUserScopeReturn = "";
	try {
	    companyUserScopeReturn = companyUserScopeService.isAccessGrantedFor("dinuka", "company-user",
		    APIOperations.GET.toString());
	...
	try {
	    companyUserScopeReturn = companyUserScopeService.isAccessGrantedFor("dinuka", "software",
		    APIOperations.GET.toString());
	...
	try {
	    ...
	    CompanyUserScope decodedAdminScope = (CompanyUserScope) decoder.decodeObject(ObjectType.COMPANY_USER_SCOPE,
		    companyUserScopeEncoded);
	    ...
	    String companyUserScopeFinalEncoded = encoder
		    .encodeObject(ObjectType.COMPANY_USER_SCOPE, decodedAdminScope);
	    companyUserScopeReturn = companyUserScopeService.updateCompanyUserScope(EncoderDecoderType.JSON,
		    companyUserScopeFinalEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	...
	try {
	    ...
	    String companyUserScopeFinalEncoded = encoder
		    .encodeObject(ObjectType.COMPANY_USER_SCOPE, decodedAdminScope);
	    companyUserScopeReturn = companyUserScopeService.deleteCompanyUserScope(EncoderDecoderType.JSON,
		    companyUserScopeFinalEncoded);
	    companyUserScopeEncoded = companyUserScopeService.getCompanyUserScope(EncoderDecoderType.JSON, "dinuka",
		    "software");
