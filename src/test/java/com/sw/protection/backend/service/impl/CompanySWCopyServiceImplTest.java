...
public class CompanySWCopyServiceImplTest {
	...
	companyClientReturn = "";
	try {
	    companyClientReturn = companyClientService.saveCompanyClient(EncoderDecoderType.JSON, companyClientEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	companySWReturn = "";
	try {
	    companySWReturn = companySwService.saveCompanySW(EncoderDecoderType.JSON, companySWEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
    }
	...
	try {
	    companySWCopyReturn = companySWCopyService.saveCompanySWCopy(EncoderDecoderType.JSON, companySWCopyEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	String companySWCopyReturn = "";
	try {
	    companySWCopyReturn = companySwCopyService.getCompanySWCopy(EncoderDecoderType.JSON, "dinuka",
		    "Application 1", "M_BOARD_ID", "HD_ID", "MAC_ID");
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companySWCopyReturn = companySwCopyService.getAllCompanySWCopy(EncoderDecoderType.JSON, 1, 20);
	    companySWCopies = (List<CompanySWCopy>) decoder.decodeObjectList(ObjectType.SOFTWARE_COPY,
		    companySWCopyReturn);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companySWCopyReturn = companySwCopyService.getAllCompanySWCopy(EncoderDecoderType.JSON, 2, 1);
	    companySWCopies = (List<CompanySWCopy>) decoder.decodeObjectList(ObjectType.SOFTWARE_COPY,
		    companySWCopyReturn);
	} catch (Exception e) {
	    e.printStackTrace();
	...
	try {
	    companySWReturn = companySWCopyService.getCompanySWCopy(EncoderDecoderType.JSON, "dinuka", "Application 1",
	...
	try {
	    companySWCopy = (CompanySWCopy) decoder.decodeObject(ObjectType.SOFTWARE_COPY, companySWReturn);
	    companySWCopy2 = (CompanySWCopy) decoder.decodeObject(ObjectType.SOFTWARE_COPY, companySWReturn);
	...
	try {
	    ...
	    finalString = companySWCopyService.updateCompanySWCopy(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
	...
	CompanySWCopy companySwCopy2 = null;
	try {
	    companySwCopy = (CompanySWCopy) decoder.decodeObject(ObjectType.SOFTWARE_COPY, companySWCopyReturn);
	    companySwCopy2 = (CompanySWCopy) decoder.decodeObject(ObjectType.SOFTWARE_COPY, companySWCopyReturn);
	} catch (DecodingException e) {
	    e.printStackTrace();
	}
	...
	try {
	    encodedString = encoder.encodeObject(ObjectType.SOFTWARE_COPY, companySwCopy);
	    finalString = companySWCopyService.deleteCompanySWCopy(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
	    requiredDataExp = e.getClass().toString();
	}
	assertEquals(requiredDataExp, RequiredDataNotFoundException.class.toString());
	...
	try {
	    encodedString = encoder.encodeObject(ObjectType.SOFTWARE_COPY, companySwCopy);
	    updatedfinalString = companySWCopyService.updateCompanySWCopy(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
