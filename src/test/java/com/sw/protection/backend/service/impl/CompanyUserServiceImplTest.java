...
public class CompanyUserServiceImplTest {
	...
	CompanyUserService companyService = AppContext.getInstance().getBean(CompanyUserService.class);
	...
	try {
	    companyUserReturn = companyService.saveCompanyUser(EncoderDecoderType.JSON, companyEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyUserReturn = companyService.saveCompanyUser(EncoderDecoderType.JSON, companyUserEncodedNew);
	} catch (Exception e) {
	...
	try {
	    companyUserReturn2 = companyService.saveCompanyUser(EncoderDecoderType.JSON, companyUserEncoded2);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyUserReturn = companyUserService.getAllCompanyUsers(EncoderDecoderType.JSON, 1, 20);
	    companyUsers = (List<CompanyUser>) decoder.decodeObjectList(ObjectType.COMPANY_USER, companyUserReturn);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyUserReturn = companyUserService.getAllCompanyUsers(EncoderDecoderType.JSON, 2, 1);
	    companyUsers = (List<CompanyUser>) decoder.decodeObjectList(ObjectType.COMPANY_USER, companyUserReturn);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	String companyUserReturn = "";
	try {
	    companyUserReturn = companyUserService.getCompanyUser(EncoderDecoderType.JSON, companyUserEncoded);
	} catch (Exception e) {
	    e.printStackTrace();
	}
	...
	try {
	    companyUser = (CompanyUser) decoder.decodeObject(ObjectType.COMPANY_USER, companyUserReturn);
	    companyUser2 = (CompanyUser) decoder.decodeObject(ObjectType.COMPANY_USER, companyUserReturn);
	...
	try {
	    ...
	    finalString = companyUserService.updateCompanyUser(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
	...
	try {
	    encodedString = encoder.encodeObject(ObjectType.COMPANY_USER, companyUser);
	    finalString = companyUserService.deleteCompanyUser(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
	    requiredDataExp = e.getClass().toString();
	}
	assertEquals(requiredDataExp, RequiredDataNotFoundException.class.toString());
	...
	try {
	    encodedString = encoder.encodeObject(ObjectType.COMPANY_USER, companyUser);
	    updatedfinalString = companyUserService.updateCompanyUser(EncoderDecoderType.JSON, encodedString);
	} catch (Exception e) {
