...
public class DecoderFactoryImplTest {
	...
	public void testJsonDecoderSuperAdmin() {
		...
		try {
			superAdminList = (List<SuperAdmin>) decoder.decodeObjectList(ObjectType.SUPER_ADMIN,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
	...
	public void testJsonDecoderCompany() {
		...
		try {
			companyList = (List<Company>) decoder.decodeObjectList(ObjectType.COMPANY,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
	...
	public void testJsonDecoderCompanyUser() {
		...
		try {
			companyList = (List<CompanyUser>) decoder.decodeObjectList(ObjectType.COMPANY_USER,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
		...
		for (CompanyUser companyUser1 : companyList) {
			...
			assertEquals(companyUser1.getCompany().getApi_key(),
	...
	public void testJsonDecoderCompanyClient() {
		...
		assertEquals(companyClient.getCompany().getApi_key(),
				"75e70eb1-7940-4234-b6c4-2870ab0bb794");
		...
		try {
			companyList = (List<CompanyClient>) decoder.decodeObjectList(ObjectType.CLIENT,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
		...
		for (CompanyClient companyClient1 : companyList) {
			...
			assertEquals(companyClient1.getCompany().getApi_key(),
					"75e70eb1-7940-4234-b6c4-2870ab0bb794");
		}
	...
	public void testJsonDecoderCompanySoftware() {
		...
		try {
			companyList = (List<CompanySW>) decoder.decodeObjectList(ObjectType.SOFTWARE,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
	...
	public void testJsonDecoderCompanySoftwareCopy() {
		...
		try {
			companyList = (List<CompanySWCopy>) decoder.decodeObjectList(ObjectType.SOFTWARE_COPY,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
	...
	public void testJsonDecoderAdminScope() {
		...
		try {
			adminList = (List<AdminScope>) decoder.decodeObjectList(ObjectType.ADMIN_SCOPE,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
		...
		for (AdminScope adminScope1 : adminList) {
			...
			assertEquals(adminScope1.getAdmin().getApi_key(),
					"75e70eb1-7940-4234-b6c4-2870ab0bb794");
		}
	...
	public void testJsonDecoderCompanyUserScope() {
		...
		try {
			companyUserScope = (CompanyUserScope) decoder.decodeObject(
					ObjectType.COMPANY_USER_SCOPE, encodedObj);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
		...
		assertEquals(companyUserScope.getCompanyUser().getApi_key(),
				"75e70eb1-7940-4234-b6c4-2870ab0bb794");
		assertEquals(companyUserScope.getCompanyUser().getCompany().getId().toString(), "2");
		assertEquals(companyUserScope.getCompanyUser().getCompany().getName(),
				"Sysensor IT Solutions");
		...
		assertEquals(companyUserScope.getCompanyUser().getCompany().getEmail(),
				"sysensor@gmail.com");
		...
		try {
			companyList = (List<CompanyUserScope>) decoder.decodeObjectList(
					ObjectType.COMPANY_USER_SCOPE, encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
		...
		for (CompanyUserScope companyUserScope1 : companyList) {
			...
			assertEquals(companyUserScope1.getCompanyUser().getApi_key(),
					"75e70eb1-7940-4234-b6c4-2870ab0bb794");
			assertEquals(companyUserScope1.getCompanyUser().getCompany().getId().toString(), "2");
			assertEquals(companyUserScope1.getCompanyUser().getCompany().getName(),
					"Sysensor IT Solutions");
			...
			assertEquals(companyUserScope1.getCompanyUser().getCompany().getEmail(),
					"sysensor@gmail.com");
	...
	public void testJsonDecoderUsage() {
		...
		try {
			companyList = (List<UsageData>) decoder.decodeObjectList(ObjectType.USAGE,
					encodedObjList);
		} catch (DecodingException e) {
			e.printStackTrace();
		}
