...
public class CompanySWAPI {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Given company software found"),
	...
	public Response getCompanySW(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
				...
				companyUserData = companySWService.getCompanySW(EncoderDecoderType.JSON, userName,
						softwareName);
			}
	...
	public Response getCompanySWList(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companySWData = companySWService.getAllCompanySW(EncoderDecoderType.JSON,
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Save company software successful"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Company software successfuly updated"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Company software successfuly deleted"),
