...
public class CompanySWCopyAPI {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Given company software copy found"),
	...
	public Response getCompanySWCopy(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
				...
				companySWCopyData = companySWCopyService.getCompanySWCopy(EncoderDecoderType.JSON,
						clientUserName, softwareName, mb, hd, mac);
			}
	...
	public Response getCompanySWCopyList(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companySWCopyData = companySWCopyService.getAllCompanySWCopy(
						EncoderDecoderType.JSON, pageNumber, itemPerList);
			}
			// TODO: Need to process the XML type requests
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Save company software copy successful"),
	...
	public Response saveCompanySWCopy(String body) {
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companySWCopyData = companySWCopyService.saveCompanySWCopy(EncoderDecoderType.JSON,
						body);
			}
			// TODO: Need to process the XML type requests
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Company software copy successfuly updated"),
	...
	public Response updateCompanySWCopy(String body) {
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companySwCopyData = companySwCopyService.updateCompanySWCopy(
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Company software copy successfuly deleted"),
	...
	public Response deleteCompanySWCopy(String body) {
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companySWCopyData = companySwCopyService.deleteCompanySWCopy(
						EncoderDecoderType.JSON, body);
			}
			// TODO: Need to process the XML type requests
