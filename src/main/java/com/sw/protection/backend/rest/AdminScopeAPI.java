...
public class AdminScopeAPI {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Given admin user found"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Given admin scope found"),
	...
	public Response getAdminScope(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				adminData = adminScopeService.getAdminScope(EncoderDecoderType.JSON, userName,
						apiName);
			}
			// TODO: Need to process the XML type requests
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Save admin scope successful"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Admin user scope successfuly updated"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Admin scope successfuly deleted"),
