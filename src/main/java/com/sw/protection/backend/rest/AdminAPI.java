...
public class AdminAPI {
	...
	public Response getAdmin(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
				...
				adminData = adminService.getAdmin(EncoderDecoderType.JSON, "{user_name:\""
						+ userName + "\"}");
			}
	...
	public Response getAdminList(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				adminData = adminService.getAllAdmins(EncoderDecoderType.JSON, pageNumber,
						itemPerList);
			}
			// TODO: Need to process the XML type requests
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Save admin user successful"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Admin user successfuly updated"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Admin user successfuly deleted"),
