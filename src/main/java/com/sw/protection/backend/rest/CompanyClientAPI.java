...
public class CompanyClientAPI {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Given company client found"),
	...
	public Response getCompanyClient(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
				...
				companyClientData = companyClientService.getCompanyClient(EncoderDecoderType.JSON,
						userName);
			}
	...
	public Response getCompanyClientList(
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companyClientData = companyClientService.getAllCompanyClients(
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Save company client successful"),
	...
	public Response saveCompanyClient(String body) {
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companyClientData = companyClientService.saveCompanyClient(EncoderDecoderType.JSON,
						body);
			}
			// TODO: Need to process the XML type requests
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Company client successfuly updated"),
	...
	public Response updateCompanyClient(String body) {
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companyClientData = companyClientService.updateCompanyClient(
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Company client successfuly deleted"),
	...
	public Response deleteCompany(String body) {
		...
		try {
			...
			if (headers.getRequestHeaders().get(ACCEPT_HEADERS)
					.contains(MediaType.APPLICATION_JSON)) {
				companyClientData = companyClientService.deleteCompanyClient(
						EncoderDecoderType.JSON, body);
			}
			// TODO: Need to process the XML type requests
