...
public class CompanySWCopyDAOImpl implements CompanySWCopyDAO {
	...
	public CompanySWCopy updateCompanySWCopy(CompanySWCopy companySWCopy)
		...
		try {
			...
			if (log.isDebugEnabled()) {
				log.debug("Locked update operation by Company software copy ID "
						+ companySWCopy.getId());
			}
			...
			if (companySWCopy.getLast_modified().equals(
					this.getCompanySWCopy(companySWCopy.getCompany_client().getUser_name(),
							companySWCopy.getCompany_sw().getName(),
							companySWCopy.getMother_board(), companySWCopy.getHd(),
							companySWCopy.getMac()).getLast_modified())) {
	...
	public CompanySWCopy deleteCompanySWCopy(CompanySWCopy companySWCopy)
		...
		try {
			...
			LOCK_MAP.lock(companySWCopy.getId());
			if (log.isDebugEnabled()) {
				log.debug("Locked delete operation by Company software copy ID "
						+ companySWCopy.getId());
			}
	...
	public CompanySWCopy saveCompanySWCopy(CompanySWCopy companySWCopy)
		...
		try {
			...
			if (this.isCompanySWCopyExist(companySWCopy.getCompany_client().getUser_name(),
					companySWCopy.getCompany_sw().getName(), companySWCopy.getMother_board(),
					companySWCopy.getHd(), companySWCopy.getMac())) {
				if (log.isDebugEnabled()) {
					log.debug("Company software copy :" + companySWCopy.toString()
							+ " already exist");
				}
	...
	public boolean validateCompanySWCopyforSave(CompanySWCopy companySWCopy) {
		...
		if (companySWCopy.getCompany_client() != null && companySWCopy.getCompany_sw() != null
				&& companySWCopy.getExpire_date() != "" && companySWCopy.getHd() != ""
				&& companySWCopy.getMac() != "" && companySWCopy.getMother_board() != "") {
			status = true;
		} else {
			status = false;
		}
	...
	public boolean validateCompanySWCopyforUpdateandDelete(CompanySWCopy companySWCopy) {
		...
		if (companySWCopy.getId() != null && companySWCopy.getCompany_sw() != null
				&& companySWCopy.getCompany_client() != null
				&& companySWCopy.getLast_modified() != null
				&& companySWCopy.getLast_modified() != "" && companySWCopy.getExpire_date() != null
				&& companySWCopy.getExpire_date() != "" && !companySWCopy.getHd().equals("")
				&& !companySWCopy.getMac().equals("")
				&& !companySWCopy.getMother_board().equals("")) {
