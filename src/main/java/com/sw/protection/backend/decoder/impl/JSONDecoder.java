...
public class JSONDecoder implements Decoder {
	...
	try {
	    ...
	    log.error(e);
	    throw new DecodingException("Provided JSON string cannot decode to list of CompanyUsers");
	}
    ...
    private List<CompanyClient> decodeCompanyClientList(String encodeString) throws DecodingException {
	Gson gson = new Gson();
	List<CompanyClient> companyClientList = null;
	try {
	    companyClientList = gson.fromJson(encodeString, new TypeToken<ArrayList<CompanyClient>>() {
	    }.getType());
	} catch (Exception e) {
	    log.error(e);
	    throw new DecodingException("Provided JSON string cannot decode to list of CompanyClients");
	}
	...
	try {
	    companySoftwareList = gson.fromJson(encodeString, new TypeToken<ArrayList<CompanySW>>() {
	    }.getType());
	} catch (Exception e) {
	    log.error(e);
	    throw new DecodingException("Provided JSON string cannot decode to list of CompanySoftwares");
	}
    ...
    private List<CompanySWCopy> decodeCompanySoftwareCopyList(String encodeString) throws DecodingException {
	Gson gson = new Gson();
	List<CompanySWCopy> companySoftwareCopyList = null;
	try {
	    companySoftwareCopyList = gson.fromJson(encodeString, new TypeToken<ArrayList<CompanySWCopy>>() {
	    }.getType());
	} catch (Exception e) {
	    log.error(e);
	    throw new DecodingException("Provided JSON string cannot decode to list of CompanySoftwareCopies");
	}
    ...
    private List<CompanyUserScope> decodeCompanyUserScopeList(String encodeString) throws DecodingException {
	Gson gson = new Gson();
	List<CompanyUserScope> companyUserScopeList = null;
	try {
	    companyUserScopeList = gson.fromJson(encodeString, new TypeToken<ArrayList<CompanyUserScope>>() {
	    }.getType());
	} catch (Exception e) {
	    log.error(e);
	    throw new DecodingException("Provided JSON string cannot decode to list of CompanyUserScopes");
	}
