...
public class Trace implements Serializable {
	...
	public String toString() {
		String output = "Trace - ID:" + id + ", APIName:" + api_name + ", Operation:" + operation
				+ ", Type:" + type + ", TypeUserName:" + type_user_name + ", Date:" + date_time
				+ ", AffectedType:" + affected_type + ", AffectedUserName:" + affected_user_name
				+ ", BData:" + before_data + ", AData:" + after_data;
		return output;
	}
}
